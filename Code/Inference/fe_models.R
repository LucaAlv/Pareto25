...
summary(lm(period_emmigration ~ total_disasters_period + mun_pop, data = mun_nodes))
summary(lm(period_immigration ~ total_disasters_period + mun_pop, data = mun_nodes))
summary(lm(net_immigration ~ total_disasters_period + mun_pop, data = mun_nodes))
